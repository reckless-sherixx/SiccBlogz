...
import { } from "@kinde-oss/kinde-auth-nextjs/server";
        ...
        <nav className="py-5 flex items-center justify-between">
            <div className="flex items-center gap-6">
                <Link href="/">
                    <h1 className="text-3xl font-bold">
                        Sicc<span className="text-blue-500">Blogz</span>
                    </h1>
                </Link>
            ...
            {user ? (
                <div className="flex items-center gap-4 pt-2">
                    <p>{user.given_name}</p>
                    <LogoutLink className={buttonVariants({ variant: "outline" })}>Logout</LogoutLink>
                </div>
            ) : (
                <div className="flex items-center gap-4 pt-2">
